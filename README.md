...
```bash
npm install unycode-nfc-scanner
npx cap sync
```
...
* [`startScan()`](#startscan)
* [`stopScan()`](#stopscan)
* [`addListener('tagDetected', ...)`](#addlistenertagdetected-)
...
### addListener('tagDetected', ...)

```typescript
addListener(eventName: 'tagDetected', listenerFunc: (data: NFCTagData) => void) => Promise<PluginListenerHandle>
```
...
| Param              | Type                                                                 |
| ------------------ | -------------------------------------------------------------------- |
| **`eventName`**    | <code>'tagDetected'</code>                                           |
| **`listenerFunc`** | <code>(data: <a href="#nfctagdata">NFCTagData</a>) =&gt; void</code> |
...
**Returns:** <code>Promise&lt;<a href="#nfctagdata">NFCTagData</a> | null&gt;</code>
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`id`**           | <code>string</code>                                                                                                                                                                                                                                                                                                                                                                                              |
| **`techTypes`**    | <code>string[]</code>                                                                                                                                                                                                                                                                                                                                                                                            |
| **`type`**         | <code>string</code>                                                                                                                                                                                                                                                                                                                                                                                              |
| **`data`**         | <code>{ tagId: string; discoveryAction: string; manufacturer?: string; type?: string; techDetails?: { mifareClassic?: any; mifareUltralight?: any; isoDep?: any; nfcA?: any; }; ndefMessages?: { records: { tnf: number; type: string; id: string; payload: string; textContent?: string; languageCode?: string; uri?: string; mimeType?: string; mimeContent?: string; jsonContent?: string; }[]; }[]; }</code> |
